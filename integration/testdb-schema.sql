...
-- Host: 127.0.0.1    Database: kaletest
-- ------------------------------------------------------

SET FOREIGN_KEY_CHECKS=0;

DROP DATABASE IF EXISTS kaletest;
CREATE DATABASE kaletest CHARACTER SET = 'utf8mb4' COLLATE 'utf8mb4_unicode_520_ci';
DROP USER IF EXISTS 'kaletest'@'localhost';
USE kaletest;
CREATE USER 'kaletest'@'localhost' IDENTIFIED BY 'kale123';
GRANT SELECT, INSERT, UPDATE, DELETE ON kaletest.* TO 'kaletest'@'localhost';
